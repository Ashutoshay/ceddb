...
<html lang="en">
  ...
  <form class="form-inline"  action ="../user/logout.php">
    ...
    <div class="row">
        ...
        <h3 class="bg-dark text-center text-white">Approved User</h3>
	...
	?>
   		<tr class="text-center">
                 ...
                 <td><?php echo $res['email_id']; ?></td>
   				...
   				<td><a href="requestAction/blocked.php?id=<?php echo $res['id']; ?>"> <button class="btn btn-outline-danger my-2 my-sm-0">Blocked</button></a>
                </td>
