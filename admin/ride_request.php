...
$sql = " select signup.id, signup.name,ride.ride_id, ride.ride_status,ride.cab_type, ride.pickup, ride.drop_point, ride.total_distance, ride.luggage, ride.ride_date, ride.total_fare from signup Inner join ride on signup.id=ride.id ";
...
<html lang="en">
  ...
  <form class="form-inline"  action ="../user/logout.php">
    ...
    <div class="row">
        ...
        <h3 class="bg-dark text-center text-white"> Rides Request</h3>
	...
	?>
          ...
          <td><a href="requestAction/accept.php?id=<?php echo $res['ride_id']; ?>"> <button class="btn btn-outline-success my-2 my-sm-0">Accept</button></a>
          <a href="requestAction/cancel.php?id=<?php echo $res['ride_id']; ?>"> <button class="btn btn-outline-danger my-2 my-sm-0">Cancel</button></a></td>
