...
<html lang="en">
  ...
  <form class="form-inline"  action ="../user/logout.php">
    ...
    <div class="row">
        ...
        <h3 class="bg-dark text-center text-white">Pending User</h3>
    ...
    // echo var_dump($result['status']);
			...
			while ($res = mysqli_fetch_array($query)) { echo $res['status'];
                if($res['status'] == 0){
	...
	?>
   		<tr class="text-center">
                 ...
                 <td><?php echo $res['email_id']; ?></td>
   				<td><?php echo $res['signup_date']; ?></td>
   				<td><?php echo $res['mobile_no']; ?></td>
   				<td><a href="requestAction/unblocked.php?id=<?php echo $res['id']; ?>"> <button class="btn btn-outline-success my-2 my-sm-0">Accept</button></a>
                </td>
