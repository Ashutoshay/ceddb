...
<html lang="en">
  ...
  <form class="form-inline"  action ="../user/logout.php">
    ...
    <div class="row">
        ...
        <h3 class="bg-dark text-center text-white">Available Location</h3>
	...
	?>
   		<tr class="text-center">
                 ...
                 <td><?php echo $res['location_distance']; ?></td>
                 <td><a href=""> <button class="btn btn-outline-success my-2 my-sm-0">Available</button></a></td>
                 <td><a href=""> <button class="btn btn-outline-primary my-2 my-sm-0">Edit</button></a>
                 <a href=""> <button class="btn btn-outline-danger my-2 my-sm-0">Remove</button></a></td>
